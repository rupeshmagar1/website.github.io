...
<div class="heading">
	...
	<div class="menu">
		<p><a href="index.php">Home</a></p>&nbsp;&nbsp;<p class="text-green" style="font-size:25px">/</p>
		<p><a href="#" style="color:#000;">Gallery</a></p>
</div>
</div>
<!-- image gallery -->
	<section class="tour">
